...
# Printing landmarks in user friendly way:
landmark_string=""
for letter, landmark in landmark_choices.items():
  landmark_string += "{0} - {1}\n".format(letter, landmark)

#Add stations which are under constructions to the list
...
# Set the initial points of journey
...
def get_start():
  ...
  if start_point_letter in landmark_choices:
    ...
    print("Sorry, that's not a landmark we have a data on. Let's try this again...")
    get_start()
...
#Returns a new graph with only active stations
